...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geofence.GeofenceLocationService, Plugin.Geofence.Droid", GeofenceLocationService.class, __md_methods);
	}
	...
	public GeofenceLocationService ()
	{
		...
		if (getClass () == GeofenceLocationService.class)
			mono.android.TypeManager.Activate ("Plugin.Geofence.GeofenceLocationService, Plugin.Geofence.Droid", "", this, new java.lang.Object[] {  });
	}
