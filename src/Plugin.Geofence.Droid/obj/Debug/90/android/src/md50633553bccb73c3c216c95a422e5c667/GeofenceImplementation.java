...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geofence.GeofenceImplementation, Plugin.Geofence.Droid", GeofenceImplementation.class, __md_methods);
	}
	...
	public GeofenceImplementation ()
	{
		...
		if (getClass () == GeofenceImplementation.class)
			mono.android.TypeManager.Activate ("Plugin.Geofence.GeofenceImplementation, Plugin.Geofence.Droid", "", this, new java.lang.Object[] {  });
	}
